<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $user = array(
            ...
            'Firstname' => $_POST['firstname'], // Retrieve Firstname from the form
            'Lastname' => $_POST['lastname'], // Retrieve Lastname from the form
            'HashedPassword' => $_POST['password'] // Retrieve HashedPassword from the form
        );

        // Prepare the API request
        $url = 'http://127.0.0.1:8080/bookstore_php/api/user.api.php';
        $data = array(
            'action' => 'add_user',
            'user' => $user
        );
