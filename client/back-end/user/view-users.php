...
$data = array('action' => 'get_all_users');
                                ...
                                <div class="card-body">
                                    <div class="title-header option-title">
                                        ...
                                        <form class="d-inline-flex">
                                            <a href="../user/add-user.php" class="align-items-center btn btn-theme d-flex">
                                                ...
                                                <?php foreach ($users as $user) : ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <ul>
                                                                <li>
                                                                    <a href="../user/edit-user.php?userId=<?php echo $user['UserId']; ?>">
