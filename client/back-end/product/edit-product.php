                                                ...
                                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel">
                                                    <form method="POST" class="theme-form theme-form-2 mega-form">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <!-- Input fields to edit book information -->
                                                            <div class="mb-4 row align-items-center">
                                                                <label class="form-label-title col-lg-2 col-md-3 mb-0">
                                                                    Book Title
                                                                </label>
                                                                <div class="col-md-9 col-lg-10">
                                                                    <input class="form-control" type="text" name="bookTitle" value="<?php echo isset($bookData['BookTitle']) ? $bookData['BookTitle'] : ''; ?>">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="mb-4 row align-items-center">
                                                                ...
                                                                <div class="col-md-9 col-lg-10">
                                                                    <input class="form-control" type="text" name="author" value="<?php echo isset($bookData['Author']) ? $bookData['Author'] : ''; ?>">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="mb-4 row align-items-center">
                                                                ...
                                                                <div class="col-md-9 col-lg-10">
                                                                    <input class="form-control" type="number" name="quantity" value="<?php echo isset($bookData['AmountInStock']) ? $bookData['AmountInStock'] : ''; ?>">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="mb-4 row align-items-center">
                                                                ...
                                                                <div class="col-md-9 col-lg-10">
                                                                    <input class="form-control" type="number" name="price" value="<?php echo isset($bookData['Price']) ? $bookData['Price'] : ''; ?>">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="mb-4 row align-items-center">
                                                                ...
                                                                <div class="col-md-9 col-lg-10">
                                                                    <select class="form-control" name="genre" id="userType">
                                                                        ...
                                                                        <option value="Horror" <?php echo (isset($bookData['Genre']) && $bookData['Genre'] === 'Horror') ? 'selected' : ''; ?>>Horror</option>
                                                                        <option value="Comedy" <?php echo (isset($bookData['Genre']) && $bookData['Genre'] === 'Comedy') ? 'selected' : ''; ?>>Comedy</option>
